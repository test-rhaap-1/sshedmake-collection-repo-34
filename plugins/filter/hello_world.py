"""A hello-world filter plugin in sshedmake_namespace_34.myrhdh_34."""
...
DOCUMENTATION = """
    name: hello_world
    author: Sshedmake_namespace_34 Myrhdh_34
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | sshedmake_namespace_34.myrhdh_34.hello_world }}"
"""
